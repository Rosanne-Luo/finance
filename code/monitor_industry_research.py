...
url = ("http://reportapi.eastmoney.com/report/list?"
       ...
       "&ratingChange=*&beginTime="+date_time+"&endTime="+date_time+
...
for pageNum in range(1, pages+1):
    ...
    for data in datas:
        ...
        report = "{}-{}-{}-{}".format(publishDate, industryName, title, orgSName)
        if industryCode in monitor_industry.keys() and title.find("周报")==-1:
            print(report)
